  ...
  return (
    <div className="w-full px-4">
      <div className="mt-8 flex flex-col items-center w-full">
        ...
        <div className="bg-[#93C5FD] w-full h-[424px] mt-8 flex flex-col items-center rounded">
          ...
          <img
            src={ImageFrameVideo}
            alt=""
            className="h-[280px] mt-6 sm:h-[380px]"
          />
        </div>
      </div>
      ...
      <div className="mt-16 sm:mt-28 flex flex-col items-center lg:items-start">
        ...
        <div>
          <p className="text-sm mb-4 sm:text-base text-center lg:text-start">
          ...
          <p className="text-sm mb-4 sm:text-base text-center lg:text-start">
            ...
            <span className="relative group cursor-pointer text-blue-500 underline">
              ...
              <span className="absolute left-1/2 -translate-x-1/2 top-full mt-2 w-56 bg-gray-800 text-white text-xs rounded-lg shadow-lg px-4 py-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10 sm:w-72 sm:text-sm">
      ...
      <div className="mt-10">
        <h2 className="text-xl font-bold mb-4 bg-gradient-to-r from-white to-blue-300 bg-clip-text text-transparent text-center sm:text-2xl lg:text-4xl lg:text-start">
          Fundadores
        </h2>
        ...
        <div className="flex flex-col items-center gap-6 mt-8 lg:flex-row">
          ...
          <div className="lg:w-2/3 flex flex-col items-center justify-center lg:items-start">
            <p className="font-bold text-xl sm:text-2xl text-center lg:text-start">
              Mikael Ribeiro
            </p>
            <p className="mt-4 text-sm sm:text-base text-center lg:text-start">
