...
export function SectionLatestPosts() {
  return (
    <section className="mt-16">
      <h3 className="text-2xl font-bold text-white mb-4 bg-gradient-to-r from-white to-blue-300 bg-clip-text text-transparent w-full text-center md:text-4xl lg:text-left lg:w-[24rem]">
